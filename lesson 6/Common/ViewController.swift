...
//  lesson 6
//
//  Created by MacBook Pro on 1/2/24.
//
...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    private var simpleCollectionView: UICollectionView = {
        ...
        cv.register(CollectionView.self, forCellWithReuseIdentifier: "cell")
        return cv
    }()
    ...
    private let verticalCollectionView: UICollectionView = {
        ...
        let cv = UICollectionView(frame: .zero, collectionViewLayout: layout)
        cv.translatesAutoresizingMaskIntoConstraints = false
        cv.register(UICollection.self, forCellWithReuseIdentifier: "verticalCell")
        return cv
    }()
    ...
    override func viewDidLoad() {
        ...
        simpleCollectionView.backgroundColor = UIColor(hex: "#ffffff")
        ...
        verticalCollectionView.backgroundColor = UIColor(hex: "#ffffff")
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == simpleCollectionView {
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "verticalCell", for: indexPath) as? UICollection
